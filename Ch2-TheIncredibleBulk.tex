...
This chapter is based on a paper written by me and my supervisor Anton Zilman, currently submitted to Royal Society Interfaces journal. 
...
As in the previous chapter, I focus on this latter type of stochasticity, known as demographic noise. %NTS:::this should be in the intro. - it now is
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.7\textwidth]{two-resources}
