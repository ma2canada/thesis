...
Where two species with overlapping niches can coexist, so too may more. %NTS:::blegh
...
The different regions of the phase space in Figure \ref{phasespace} have different biological interpretations \cite{Abrams1977,Neuhauser1999,Cox2010}. 
...
\end{equation}
with $\frac{1}{\alpha}\simeq \frac{1}{K}e^K$ from the previous chapter \cite{Lande1993,Lambert2005}. %NTS:::from the previous chapter now
...
\section{Fokker-Planck analysis in this context} \label{FPsection}
