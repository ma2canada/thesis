...
\usepackage{hyperref}%%%%NTS::: %%%EDIT::: TEST THIS
...
%Stochastic fluctuations allow for an otherwise stable population to exhibit extinction. 
Stochastic fluctuations allow mathematical models, like the neutral Moran model, to exhibit extinction. % rapidly-fixating
...
The extinction times in the neutral and niche limits are qualitatively different, indicative respectively of exclusion and coexistence of two species, yet the transition between these limits has not been fully investigated. 
