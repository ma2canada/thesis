...
The extinction times in the neutral and niche limits are qualitatively different, indicative respectively of fixation and coexistence of the two species, yet the transition has not been fully investigated. 
...
I discover that competing species can coexist unless their ecological niches entirely overlap, which implies that extinction and loss of biodiversity is less common than predicted by neutral models. 
...
\include{Ch1-KiIsCon}
\include{Ch2-TheLoneliestNumber}
\include{Ch3-TheIncredibleBulk}
\include{Ch4-Immigrant}
\include{Ch5-Song}
\include{Ch6-UltimateShowdown}
