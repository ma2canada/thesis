...
Along with the problem of the maintenance biodiversity in its own right, I have other motivations related to biodiversity is it manifests in various systems. 
...
A deterministic system like the logistic one shown in the black line of figure \ref{singlelogfig} has a continuous solution, but a real population cannot vary continuously between 7 and 8; rather, it is discretized. % (see figure \ref{latticefig}). 
